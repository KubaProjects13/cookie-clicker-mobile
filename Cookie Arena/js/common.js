...
let eventFight = parseInt(localStorage.getItem("eventFight")) || 0;
let eventsPlayed = parseInt(localStorage.getItem("eventsPlayed")) || 0;
...
function updatestorage() {
    ...
    localStorage.setItem("eventFight", eventFight);
    localStorage.setItem("eventsPlayed", eventsPlayed);
