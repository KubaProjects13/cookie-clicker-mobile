...
if (SkinCollection.includes("1")) {
    skinsOutput.innerHTML += `
            <div class="widget" data-skin="1" style="text-align: center;">
                ...
                <img src="img/skins/default/cookie 300x300.png" alt="Skin" class="skin-img">
...
if (SkinCollection.includes("2")) {
    skinsOutput.innerHTML += `
            <div class="widget" data-skin="2" style="text-align: center;">
                ...
                <p>tastes good</p>
                <img src="img/skins/dark/cookie 300x300.png" alt="Skin" class="skin-img">
                <button class="pick-btn">pick</button>
            </div>
    `;
};
...
if (SkinCollection.includes("3")) {
    skinsOutput.innerHTML += `
            <div class="widget" data-skin="3" style="text-align: center;">
                ...
                <p>so white</p>
                <img src="img/skins/white/cookie 300x300.png" alt="Skin" class="skin-img">
                <button class="pick-btn">pick</button>
            </div>
    `;
};

if (SkinCollection.includes("4")) {
    skinsOutput.innerHTML += `
            <div class="widget" data-skin="4" style="text-align: center;">
                <h2>dubai chocolate</h2>
                <p>so white</p>
                <img src="img/skins/dubai/cookie 300x300.png" alt="Skin" class="skin-img">
                <button class="pick-btn">pick</button>
            </div>
    `;
};
